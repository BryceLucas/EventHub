    ...
    <div className="min-h-screen w-full bg-gradient-to-r from-pink-200 via-orange-200 to-yellow-200 p-6 font-sans">
      ...
      <header className="flex items-center justify-between mb-8">
        <nav className="flex space-x-6 text-lg font-semibold">
          ...
          <a href="#" className="hover:text-purple-700">MAP</a>
          <a href="#" className="hover:text-purple-700">PLANNER</a>
          <a href="#" className="hover:text-purple-700">ASSISTANT</a>
        </nav>

        {/* Logo */}
        <div className="bg-yellow-400 px-4 py-2 rounded-md shadow-md text-purple-900 font-bold border-2 border-purple-700">
          EVENTHUB
        </div>
      </header>
