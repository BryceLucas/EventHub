    ...
    <main className="min-h-screen flex flex-col p-6 max-w-6xl mx-auto">
      ...
      <div className="mb-12">
        <section className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {/* Browse Events */}
          <a
            href="/events/browse" // ✅ go to browse/search page
            className="rounded-2xl p-5 transition"
            style={{
              background:
                "linear-gradient(135deg, #FFCC0D66 0%, #FF194D66 40%)",
          ...
          {/* Map */}
          <a
            href="/events" // ✅ map lives at /events
            className="rounded-2xl p-5 transition"
            style={{
              background:
                "linear-gradient(135deg, #FFCC0D66 0%, #FF194D66 40%)",
          ...
          >
            ...
            <p className="text-sm text-black mt-1">
              See event locations near you with an interactive map (coming
              soon).
            </p>
          </a>
